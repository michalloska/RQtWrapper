...
void UserInterface::setupUi(MainWindow *mainWindow) {
    ...
    canvasMap["leftCanvas"] = new RQtWidget(verticalLayoutWidget);
    canvasMap["rightCanvas"] = new RQtWidget(verticalLayoutWidget);

    horizontalLayout->addWidget(canvasMap.at("leftCanvas"));
    horizontalLayout->addWidget(canvasMap.at("rightCanvas"));

    displayMemberSizes();

    ///DRAWING:
    DrawPlot(canvasMap.at("leftCanvas"));
    Candleplot(canvasMap.at("rightCanvas"));
}
...
//DEBUG PURPOSES ONLY:
void UserInterface::displayMemberSizes() {
    std::cout << "======================================================" << std::endl;
    std::cout << "centralWidget " << centralWidget->width() << ", " << centralWidget->height() << std::endl;
    std::cout << "verticalLayoutWidget " << verticalLayoutWidget->width() << ", " << verticalLayoutWidget->height()
              << std::endl;
    std::cout << "======================================================" << std::endl;
}
